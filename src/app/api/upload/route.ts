  ...
  try {
    ...
    const normalizeRow = (row: any) => {
      ...
      return {
        ...
        id_cliente: getVal(['ID CLIENTE', 'ID_CLIENTE', 'CLIENTE'])?.toString() || null,
        cliente_nome: getVal(['CLIENTE NOME', 'CLIENTE_NOME', 'NOME CLIENTE', 'CLIENTE N'])?.toString() || null,
    ...
    if (isCSV) {
      ...
      const colIdx = {
        ...
        id_cliente: findIdx(['ID CLIENTE', 'ID_CLIENTE', 'CLIENTE', 'COD CLIENTE']),
        cliente_nome: findIdx(['CLIENTE NOME', 'CLIENTE_NOME', 'NOME CLIENTE', 'CLIENTE N', 'RAZAO SOCIAL']),
